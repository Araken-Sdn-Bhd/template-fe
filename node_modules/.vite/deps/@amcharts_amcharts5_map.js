...
var MapLineSeries = function(_super) {
  ...
  Object.defineProperty(MapLineSeries2.prototype, "_handlePointsToConnect", {
    enumerable: false,
    configurable: true,
    writable: true,
    value: function(dataItem) {
...
var MapChart = function(_super) {
  ...
  Object.defineProperty(MapChart2.prototype, "geoPoint", {
    enumerable: false,
    configurable: true,
    writable: true,
    value: function() {
  ...
  Object.defineProperty(MapChart2.prototype, "getArea", {
    enumerable: false,
    configurable: true,
    writable: true,
    value: function(dataItem) {
...
var MapPointSeries = function(_super) {
  ...
  Object.defineProperty(MapPointSeries2.prototype, "disposeDataItem", {
    enumerable: false,
    configurable: true,
    writable: true,
    value: function(dataItem) {
      ...
      if (chart) {
        chart.series.each(function(series) {
          if (series.isType("MapLineSeries")) {
            each(series.dataItems, function(di) {
