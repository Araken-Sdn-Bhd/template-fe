...
function y() {
  ...
  return new Promise(function(t2, n2) {
    ...
    if (document.getElementById("vue-yandex-maps"))
      ...
      var o2 = document.createElement("SCRIPT"), r2 = e2.apiKey, a2 = r2 === void 0 ? "" : r2, i2 = e2.lang, s2 = i2 === void 0 ? "ru_RU" : i2, c2 = e2.version, l2 = c2 === void 0 ? "2.1" : c2, u2 = e2.coordorder, p2 = u2 === void 0 ? "latlong" : u2, m2 = e2.debug, f2 = m2 !== void 0 && m2, h3 = e2.enterprise, y2 = h3 !== void 0 && h3, b2 = f2 ? "debug" : "release", v2 = "lang=".concat(s2).concat(a2 && "&apikey=".concat(a2), "&mode=").concat(b2, "&coordorder=").concat(p2), g2 = "https://".concat(y2 ? "enterprise." : "", "api-maps.yandex.ru/").concat(l2, "/?").concat(v2);
...
var O = { pluginOptions: {}, provide: function() {
  ...
  return this.balloonComponent != null && (o2 = this.balloonComponent, r2 = null, a2 = "vue-balloon-".concat(v), v += 1, n2 = function(e3, t3) {
  ...
  if (this.myMap = {}, this.markers = [], window.ymaps && ymaps.GeoObjectCollection && (this.initWithoutMarkers || this.$slots.default() || this.placemarks.length)) {
    ...
    this.scrollZoom === false && this.myMap.behaviors.disable("scrollZoom"), this.isReady = true, this.$emit("map-was-initialized", this.myMap);
  }
  ...
  this.myMap.geoObjects.each(function(e3) {
    ...
    if (t2.useObjectManager)
      ...
      r2 === 0 || r2 === o2.length ? t2.myMap.geoObjects.remove(n3) : o2.length && o2.forEach(function(e3) {
        return n3.remove(e3);
      });
    }
...
var M = { inject: ["useObjectManager", "addMarker", "deleteMarker", "compareValues", "makeComponentBalloonTemplate"], props: { coords: Array, hintContent: String, icon: Object, balloon: Object, markerType: { type: String, validator: function(e2) {
  ...
  Object.keys(this.$props).forEach(function(t2) {
    t2 !== "balloonComponentProps" && e2.unwatchArr.push(e2.$watch(t2, function(t3, n2) {
  ...
  this.balloonTemplate && (n2 = ymaps.templateLayoutFactory.createClass(this.balloonTemplate)), this.$slots.balloon && (n2 = ymaps.templateLayoutFactory.createClass(this.$slots.balloon()[0].elm.outerHTML)), this.makeComponentBalloonTemplate && (n2 = this.makeComponentBalloonTemplate(this, t2)), n2 != null && (t2.balloonOptions.balloonContentLayout = n2), this.icon && ["default#image", "default#imageWithContent"].includes(this.icon.layout) ? (t2.iconContent = this.icon.content, t2.iconLayout = this.icon.layout, t2.iconImageHref = this.icon.imageHref, t2.iconImageSize = this.icon.imageSize, t2.iconImageOffset = this.icon.imageOffset, t2.iconContentOffset = this.icon.contentOffset, this.icon.contentLayout && typeof this.icon.contentLayout == "string" && (t2.iconContentLayout = ymaps.templateLayoutFactory.createClass(this.icon.contentLayout))) : t2.icon = this.icon;
  ...
  o2 === "Circle" && (t2.coords = [t2.coords, t2.circleRadius]);
...
}, typeof window != "undefined" && window.Vue && window.Vue.use(O);
var w = y;
var I = O;
var L = M;
