...
const __default__ = defineComponent({
  ...
  props: __spreadProps(__spreadValues(__spreadValues({}, useFormProps), useValidationProps), {
  ...
  setup(props) {
    ...
    const wrapperClass = useBem("va-input-wrapper", () => __spreadProps(__spreadValues({}, pick_1(props, ["outline", "bordered", "success", "focused", "error", "disabled", "readonly"])), {
      labeled: !!props.label,
