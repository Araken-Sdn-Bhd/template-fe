...
const _sfc_main = defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const computedProps = computed(() => __spreadValues({}, pick_1(props, ["disabled", "readonly", "placeholder", "ariaLabel"])));
    const focus = () => {
      var _a;
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, __spreadValues(__spreadValues({}, _ctx.computedProps), _ctx.listeners), { value: _ctx.modelValue }), null, 16, _hoisted_1);
}
