...
const _sfc_main = defineComponent({
  ...
  props: __spreadProps(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues({}, useFormProps), useValidationProps), useClearableProps), useCleaveProps), VaTextareaProps), useComponentPresetProp), {
