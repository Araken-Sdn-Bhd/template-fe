...
import { defineComponent, shallowRef, computed, nextTick, resolveComponent, openBlock, createBlock, mergeProps, withCtx, createVNode, createSlots, createElementVNode, toHandlers, withModifiers, withKeys, createCommentVNode, renderList, renderSlot, normalizeProps, guardReactiveProps } from "vue";
import { o as omit_1 } from "../../../vendor.mjs";
import { e as extractComponentProps, f as filterComponentProps } from "../../utils/child-props.mjs";
...
const _sfc_main = defineComponent({
  ...
  props: __spreadProps(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues({}, VaDropdownProps), useComponentPresetProp), useClearableProps), VaInputWrapperProps), extractComponentProps(_VaTimePicker)), useValidationProps), {
  ...
  setup(props, { emit, slots, attrs }) {
    ...
    const dropdownPropsComputed = computed(() => __spreadProps(__spreadValues({}, filterComponentProps(props, VaDropdownProps).value), {
  ...
  return openBlock(), createBlock(_component_va_dropdown, mergeProps({
    ...
    anchor: withCtx(() => [
      createVNode(_component_va_input_wrapper, mergeProps({
        ...
        icon: withCtx(() => [
          _ctx.canBeClearedComputed ? (openBlock(), createBlock(_component_va_icon, mergeProps({ key: 0 }, __spreadValues(__spreadValues({}, _ctx.iconProps), _ctx.clearIconProps), {
