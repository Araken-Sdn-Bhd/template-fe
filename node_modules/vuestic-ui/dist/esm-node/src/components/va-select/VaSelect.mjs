...
const _sfc_main = defineComponent({
  ...
  props: __spreadProps(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues({}, VaDropdownProps), useSelectableListProps), useValidationProps), useLoadingProps), useMaxSelectionsProps), useClearableProps), useFormProps), useComponentPresetProp), {
    modelValue: {
