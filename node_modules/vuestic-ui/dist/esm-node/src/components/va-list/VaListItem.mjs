...
var VaListItem_vue_vue_type_style_index_0_lang = "";
const _sfc_main = defineComponent({
  name: "VaListItem",
  emits: ["focus", "click"],
  props: __spreadProps(__spreadValues(__spreadValues({}, useRouterLinkProps), useComponentPresetProp), {
    tag: { type: String, default: "div" },
    disabled: { type: Boolean, default: false }
  }),
  setup(props) {
    const tabIndexComputed = computed(() => props.disabled ? -1 : 0);
    const computedClass = useBem("va-list-item", () => __spreadValues({}, pick_1(props, ["disabled"])));
    return __spreadProps(__spreadValues({}, useRouterLink(props)), {
      tabIndexComputed,
      computedClass
    });
  }
...
//# sourceMappingURL=VaListItem.mjs.map
