...
import { d as colorToRgba } from "../../../services/color-config/color-functions.mjs";
...
var VaFileUploadGalleryItem_vue_vue_type_style_index_0_lang = "";
...
const _sfc_main = defineComponent({
  ...
  setup(props, { emit }) {
    ...
    return __spreadProps(__spreadValues(__spreadProps(__spreadValues({}, useTranslation()), {
      undo
