...
import { a as getBoxShadowColor, b as getFocusColor, c as getHoverColor } from "../../services/color-config/color-functions.mjs";
...
const _sfc_main = defineComponent({
  ...
  props: __spreadProps(__spreadValues(__spreadValues(__spreadValues(__spreadValues({}, useRouterLinkProps), useColorProps), useStatefulProps), useComponentPresetProp), {
  ...
  setup(props, { emit }) {
    ...
    return __spreadProps(__spreadValues({}, useTranslation()), {
      ...
      computedClass: useBem("va-chip", () => __spreadProps(__spreadValues({}, pick_1(props, ["disabled", "square"])), {
