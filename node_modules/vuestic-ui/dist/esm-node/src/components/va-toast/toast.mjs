...
import { a as getGlobal } from "../../utils/ssr-utils.mjs";
import { V as VaToast } from "./index.mjs";
const GAP = 5;
let seed = 1;
...
const mount = (component, {
  ...
  vNode = createVNode(component, __spreadProps(__spreadValues({}, props), { onClose }), children);
  if (appContext) {
...
export { closeById as a, closeAllNotifications as b, createToastInstance as c };
