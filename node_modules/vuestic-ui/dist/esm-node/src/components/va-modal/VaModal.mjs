...
const ModalElement = defineComponent({
  ...
  setup: (props, { slots, attrs }) => () => {
    var _a;
    return props.isTransition ? h(Transition, __spreadValues({}, attrs), slots) : (_a = slots.default) == null ? void 0 : _a.call(slots, attrs);
  }
});
const _sfc_main = defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const publicMethods = __spreadProps(__spreadValues({}, useTranslation()), {
      show,
      hide,
      toggle,
      cancel,
