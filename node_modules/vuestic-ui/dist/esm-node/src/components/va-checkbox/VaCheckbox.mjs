...
import { g as generateUniqueId } from "../../services/utils.mjs";
...
var VaCheckbox_vue_vue_type_style_index_0_lang = "";
...
const _sfc_main = defineComponent({
  ...
  props: __spreadProps(__spreadValues(__spreadValues({}, useSelectableProps), useComponentPresetProp), {
