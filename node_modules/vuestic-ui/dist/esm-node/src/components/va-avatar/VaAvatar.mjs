...
var VaAvatar_vue_vue_type_style_index_0_lang = "";
const _sfc_main = defineComponent({
  name: "VaAvatar",
  components: { VaIcon, VaProgressCircle },
  props: __spreadProps(__spreadValues(__spreadValues(__spreadValues({}, useLoadingProps), useSizeProps), useComponentPresetProp), {
