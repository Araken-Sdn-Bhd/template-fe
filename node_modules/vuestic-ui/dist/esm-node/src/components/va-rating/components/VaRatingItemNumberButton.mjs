...
const _sfc_main = defineComponent({
  ...
  props: __spreadProps(__spreadValues(__spreadValues({}, useVaRatingColorsProps), useSizeProps), {
    itemNumber: { type: Number, required: true },
    modelValue: { type: Number, required: true }
  }),
  setup(props) {
    return __spreadValues(__spreadValues({}, useVaRatingColors(props)), useSize(props, "VaRating"));
  }
});
