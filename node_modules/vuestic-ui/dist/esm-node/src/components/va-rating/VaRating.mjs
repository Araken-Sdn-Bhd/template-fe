...
const _sfc_main = defineComponent({
  name: "VaRating",
  props: __spreadProps(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues({}, useRatingProps), useVaRatingColorsProps), useFormProps), VaRatingItemProps), VaRatingItemNumberButtonProps), useComponentPresetProp), {
  ...
  setup(props) {
    ...
    return __spreadProps(__spreadValues(__spreadValues(__spreadValues({}, useTranslation()), useVaRatingColors(props)), rating), {
      rootClass,
