...
var VaDatePicker_vue_vue_type_style_index_0_lang = "";
...
const _sfc_main = defineComponent({
  ...
  props: __spreadProps(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues({}, useStatefulProps), useComponentPresetProp), extractComponentProps(VaDatePickerHeader)), extractComponentProps(VaDayPicker)), extractComponentProps(VaMonthPicker)), extractComponentProps(VaYearPicker)), {
