...
import { defineComponent, shallowRef, ref, toRefs, computed, watch, nextTick, resolveComponent, openBlock, createBlock, mergeProps, withCtx, renderSlot, normalizeProps, guardReactiveProps, createVNode, createSlots, createElementVNode, toHandlers, withModifiers, withKeys, createCommentVNode, renderList } from "vue";
import { o as omit_1 } from "../../../vendor.mjs";
import { e as extractComponentProps, a as extractComponentEmits, f as filterComponentProps } from "../../utils/child-props.mjs";
...
const _sfc_main = defineComponent({
  ...
  props: __spreadProps(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues({}, VaDropdownProps), useClearableProps), VaInputWrapperProps), VaDatePickerProps), useValidationProps), useComponentPresetProp), {
