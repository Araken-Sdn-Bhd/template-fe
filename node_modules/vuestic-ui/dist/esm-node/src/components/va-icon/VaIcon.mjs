...
import { u as useIcons } from "../../services/icon-config/icon-config-hooks.mjs";
...
var VaIcon_vue_vue_type_style_index_0_lang = "";
const _sfc_main = defineComponent({
  name: "VaIcon",
  props: __spreadProps(__spreadValues(__spreadValues({}, useSizeProps), useComponentPresetProp), {
  ...
  setup(props, { attrs }) {
    ...
    const computedAttrs = computed(() => __spreadValues(__spreadValues({}, iconConfig.value.attrs), omit_1(attrs, ["class"])));
