...
const _sfc_main = defineComponent({
  ...
  props: __spreadProps(__spreadValues(__spreadValues(__spreadValues(__spreadValues({}, useComponentPresetProp), VaButtonProps), VaDropdownProps), useStatefulProps), {
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", {
    ...
    !_ctx.$props.split ? (openBlock(), createBlock(_component_va_dropdown, mergeProps({ key: 0 }, _ctx.vaDropdownProps, {
      ...
      anchor: withCtx(() => [
        createVNode(_component_va_button, mergeProps(__spreadValues(__spreadValues({}, _ctx.computedButtonIcons), _ctx.buttonPropsComputed), toHandlers(_ctx.listeners), {
