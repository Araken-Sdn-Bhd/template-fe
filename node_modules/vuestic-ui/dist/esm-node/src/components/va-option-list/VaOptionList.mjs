...
const _sfc_main = defineComponent({
  ...
  props: __spreadProps(__spreadValues(__spreadValues(__spreadValues(__spreadValues({}, useComponentPresetProp), useSelectableListProps), useValidationProps), useStatefulProps), {
    type: {
      type: String,
      default: "checkbox",
