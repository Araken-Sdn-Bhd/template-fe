...
const _sfc_main = defineComponent({
  ...
  props: __spreadProps(__spreadValues(__spreadValues({}, useTrackByProps), useVirtualScrollerSizesProps), {
  ...
  setup: (props, { emit }) => {
    ...
    const wrapperClassComputed = useBem("va-virtual-scroller", () => __spreadValues({}, pick_1(props, ["horizontal"])));
