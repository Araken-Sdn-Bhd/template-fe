...
import { defineComponent, computed, toRefs, shallowRef, useCssVars, resolveComponent, openBlock, createBlock, resolveDynamicComponent, mergeProps, withCtx, createElementVNode, normalizeClass, createCommentVNode, renderSlot, normalizeProps, createVNode } from "vue";
...
import { c as checkSlotChildrenDeep } from "../../services/utils.mjs";
...
const __default__ = defineComponent({
  ...
  props: __spreadProps(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues({}, useComponentPresetProp), useSizeProps), useHoverStyleProps), usePressedStyleProps), useLoadingProps), useRouterLinkProps), {
  ...
  setup(props, { slots }) {
    ...
    const computedClass = useBem("va-button", () => __spreadProps(__spreadValues({}, pick_1(props, ["disabled", "block", "loading", "round", "plain"])), {
    ...
    const computedStyle = computed(() => __spreadValues({
