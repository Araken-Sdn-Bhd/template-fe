...
export declare const VaSelect: import("vue").DefineComponent<{
    ...
    optionList: import("vue").ShallowRef<import("vue").DefineComponent<{
        ...
        getText: {
            type: import("vue").PropType<(option: import("./types").SelectOption) => string>;
            required: true;
        };
        getTrackBy: {
            type: import("vue").PropType<(option: import("./types").SelectOption) => number>;
            required: true;
        };
        getGroupBy: {
            type: import("vue").PropType<(option: import("./types").SelectOption) => string>;
    ...
    getGroupBy: (option: import("./types").SelectOption) => any;
    onScrollBottom: () => void;
    clearIconProps: import("vue").ComputedRef<{
        name: string;
        color: string;
