...
export declare const GlobalConfigPlugin: import("../../../vuestic-plugin/types").VuesticPluginFabric<[config: {
    colors?: {
        variables?: {
    ...
    components?: Partial<{
        ...
        VaTreeNode: {
            readonly node: import("../../../components").TreeNode;
        };
        VaTreeView: {
            filter?: string | undefined;
            stateful?: boolean | undefined;
        ...
        all: import("../../component-config/component-config").Props;
        presets: import("../../component-config/component-config").Presets;
    }> | undefined;
    breakpoint?: {
