...
export declare const getTextColor: (color: ColorInput, darkColor: string, lightColor: string, threshold: number) => string;
export declare const getBoxShadowColor: (color: ColorInput) => string;
export declare const getBoxShadowColorFromBg: (background: ColorInput) => string;
...
export declare const applyColors: (color1: ColorInput, color2: ColorInput) => string;
