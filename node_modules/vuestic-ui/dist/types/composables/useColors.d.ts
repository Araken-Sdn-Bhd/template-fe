...
export declare const useColors: () => {
    ...
    getBoxShadowColor: (color: ColorInput) => string;
    getBoxShadowColorFromBg: (background: ColorInput) => string;
    getHoverColor: (color: ColorInput) => string;
    getFocusColor: (color: ColorInput) => string;
