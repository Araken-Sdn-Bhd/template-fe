import type { VuesticPlugin, VuesticPluginFabric } from '../types';
/**
...
export declare const createVuesticEssential: VuesticPluginFabric<[options?: {
    config?: {
        ...
        components?: Partial<{
            ...
            all: import("../../services/component-config/component-config").Props;
            presets: import("../../services/component-config/component-config").Presets;
        }> | undefined;
        breakpoint?: {
