...
import { e as extractComponentProps } from "../../utils/child-props.js";
...
const _sfc_main = defineComponent({
  ...
  props: __spreadProps(__spreadValues(__spreadValues({}, VaButtonGroupProps), useComponentPresetProp), {
  ...
  setup(props, { emit }) {
    ...
    const activeButtonPropsComputed = computed(() => __spreadValues({
    ...
    const getButtonProps = (option = {}) => {
      ...
      return __spreadValues(__spreadValues({}, isToggled(option.value) && activeButtonPropsComputed.value), iconsProps);
    };
